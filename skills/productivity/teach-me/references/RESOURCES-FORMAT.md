...
`RESOURCES.md` lives in `src/topics/<topic>/`. It is the curated set of trusted sources for the topic. Draw lesson claims from these sources instead of relying on parametric recall.
